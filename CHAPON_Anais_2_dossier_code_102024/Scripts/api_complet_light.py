...
model_path = os.path.join(current_directory, "..", "Notebooks", "mlflow_model_complet_light", "model.pkl")
...
def predict():
    try:
        ...
        csv_path = os.path.join(current_directory, "..", "Dataset", "application_train_light.csv")
